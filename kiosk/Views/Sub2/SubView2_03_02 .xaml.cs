...
namespace kiosk.Views.Sub2
{
    ...
    /// </summary>
    public partial class SubView2_03_02 : UserControl
    {
        private IRegionManager regionManager;

        public SubView2_03_02(IRegionManager regionManager)
        {
            InitializeComponent();
        ...
        {
            regionManager.RequestNavigate("ContentRegion", nameof(SubView2_03_03));
        }
    }
}
