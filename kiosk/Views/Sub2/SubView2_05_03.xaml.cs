...
namespace kiosk.Views.Sub2
{
    ...
    /// </summary>
    public partial class SubView2_05_03 : UserControl
    {
        private IRegionManager regionManager;

        public SubView2_05_03(IRegionManager regionManager)
        {
            InitializeComponent();
        ...
        {
            regionManager.RequestNavigate("ContentRegion", nameof(SubView2_05_02));
        }
    }
}
